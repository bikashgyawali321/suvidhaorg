...
class OrganizationDetailsScreen extends StatelessWidget {
  OrganizationDetailsScreen({super.key});
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: RefreshIndicator(
          onRefresh: () => organizationProvider.getOrganizationDetails(),
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                    ...
                    child: Column(
                      ...
                      children: [
                        ListTile(
                          ...
                          subtitle: Text(
                            organizationProvider.organization!.nameOrg,
                ...
                Text(
                  organizationModel.panImg.length > 1
                      ? 'PAN Images'
                      : 'PAN Image',
                  style: Theme.of(context).textTheme.bodyMedium?.copyWith(
                        fontWeight: FontWeight.bold,
